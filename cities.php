...
$cityList = getAuctionPropertiesById('city',(int)$_GET['cityId']);
//unset($_GET['cityId']);
?>
...
function doSearchByCity(cityId){
	window.location.href = '<?php echo WEB_ROOT; ?>City-Property/City-p' + cityId+'.html';
}
</script>
<style>
</style>
...
Search By City <select name="cityId" onchange="doSearchByCity(this.value);">
<option value="s" selected="selected"> -- Select a City -- </option>
	<?php echo buildCityOptions(); ?>
</select>
</div>
